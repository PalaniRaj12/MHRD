...
.pwd
{
 font-size:19px; color: black; text-shadow: 0 0 10px rgba(0,0,0,0.3); letter-spacing:1px; text-align:center; padding: 10px;
}
...
<!----->
	 ...
	 <form method="get" action="view">
      ...
      <button type="submit" value="view" name="viewbtn"class="button" style="vertical-align:middle"><span>View Scheme</span></button>
        	</form>
                     </div>
	</center>
