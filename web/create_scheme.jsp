...
.pwd
{
 font-size:17px; color: black; text-shadow: 0 0 10px rgba(0,0,0,0.3); letter-spacing:1px; text-align:center; padding: 10px;
}
...
<!----->
       ...
       <div class="content-main">
		...
		<div class="content-top">
			...
			<div class="grid-form">
		 		...
		 		<h3 id="forms-example" class="">Create Scheme</h3>
     ...
     <center>
    <div id="for"> <form method="get" action="Register">

		    	<input type="text" name="scode" placeholder="Scheme Code" required="required"/><br/><br/>

		        <input type="text" name="sname"  placeholder="Scheme name" required="required" /><br/><br/>

		        
		 		<input type="number" name="minage"  placeholder="Minimum Age" min="1" max="100" required="required" /><br/><br/>
		        <input type="number" name="maxage" placeholder="Maximum Age" min="1" max="100" required="required" ><br/><br/>
			
		                <select name="aincome">
					<optgroup label="Annual Income">
		  				<option value="60000"> less than 60,000</option>
		  				<option value="120000"> 60,000-1,20,000</option>
		  				<option value="200000"> 1,20,000-2,40,000</option>
		  				<option value="200000"> greater than 2,40,000</option>
		                                <option value="1">Any of the above</option>
		  			</optgroup>
				</select><br/><br/>

				
		        <select name="caste_category">
					<optgroup label="caste category">
		        ...
		        <select name="edu">
					<optgroup label="Educational Qualfication">
		  				<option value="TENTH">10<sup>th</sup></option>
		  				<option value="TWELTH">12<sup>th</sup></option>
		  				<option value="DEGREE_HOLDER">ANY DEGREE</option>
		  				<option value="ALL">All of the above</option>
		  			</optgroup>
				</select><br/><br/>
				...
				<select name="phy">
						...
						<optgroup label="Physically Challenged">
		        ...
		        <button type="submit" value="create" name="createbtn" class="button" style="vertical-align:middle"><span>Create Scheme</span></button>
		    </form>
    </div>
     </center>
		</div>
