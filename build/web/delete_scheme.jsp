...
.pwd
{
 font-size:13px; color: black; text-shadow: 0 0 10px rgba(0,0,0,0.3); letter-spacing:1px; text-align:center; padding: 10px;
}
       ...
       <div class="content-main">
		...
		<div class="content-top">
			...
			<div class="grid-form">
		 		...
		 		<h3 id="forms-example" class="">Delete Scheme</h3>
				 <div class="pwd">
        			<% 
...
<center id="for">
	 <form method="get" action="Delete">
          ...
          <input type="text" name="scode" placeholder="Enter Scheme Code" required="required"/><br/><br/>



      <button type="submit" value="delete" name="deletebtn" class="button" style="vertical-align:middle"><span>Delete Scheme</span></button>
        	</form>
	</center>
         </center>          
		</div>
